...
public class GeneratorSourceCodeComponentImpl  extends GeneratorSourceCode{
	...
	private static final String TEMPLATE_FILE_ENTITY = "java_component_impl";
	...
	protected boolean writeCode(DBRProgressMonitor monitor, DBSTable table, StringBuilder code) {
		...
		String fullName=JavaTemplateContext.fillRuleFullName(tableName,this.sourceCodeSetting.getRuleComponentImpl(),this.sourceCodeSetting);
