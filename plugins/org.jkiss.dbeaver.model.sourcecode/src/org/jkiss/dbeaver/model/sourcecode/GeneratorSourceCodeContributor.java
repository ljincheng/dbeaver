...
public class GeneratorSourceCodeContributor  extends CompoundContributionItem {

    static protected final Log log = Log.getLog(GeneratorSourceCodeContributor.class);
    ...
    protected IContributionItem[] getContributionItems() {
        ...
        if (structuredSelection instanceof IResultSetSelection) {
            ...
            List<SourceCodeGeneratorDescriptor> generators = GeneratorSourceCodeConfigurationRegistry.getInstance().getApplicableGenerators(objects, structuredSelection);
            int lastGrand = 0;
    ...
    private void makeResultSetContributions(List<IContributionItem> menu, IResultSetSelection rss) {
        ...
        if (dataContainer != null && !visibleAttributes.isEmpty() && entity != null) {
            ...
            if (!CommonUtils.isEmpty(selectedRows)) {
                ...
                objects.add(rsv);
                List<SourceCodeGeneratorDescriptor> generators = GeneratorSourceCodeConfigurationRegistry.getInstance().getApplicableGenerators(objects, rsv);
                for (SourceCodeGeneratorDescriptor gen : generators) {
            ...
            new Action(text, DBeaverIcons.getImageDescriptor(UIIcon.SQL_TEXT)) {
                ...
                public void run() {
                    ...
                    if (executionContext != null) {
                        ...
                        ViewSQLDialog dialog = new GeneratorSourceCodeDialog(
