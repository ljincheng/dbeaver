...
public class GeneratorSourceCodeService extends GeneratorSourceCode{
	...
	private static final String TEMPLATE_FILE_ENTITY = "java_service";
	...
	protected boolean writeCode(DBRProgressMonitor monitor, DBSTable table, StringBuilder code) {
		...
		String fullName=JavaTemplateContext.fillRuleFullName(tableName,this.sourceCodeSetting.getRuleService(),this.sourceCodeSetting);
