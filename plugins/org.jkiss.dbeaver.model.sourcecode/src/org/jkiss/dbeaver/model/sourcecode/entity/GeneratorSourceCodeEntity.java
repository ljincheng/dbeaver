...
public class GeneratorSourceCodeEntity extends GeneratorSourceCode{
	...
	private GeneratorSourceCodeExport codeExport;
	 ...
	 private String javaFileName(DBSTable table,String extFileName)
	 {
		 ...
		 String mClassFullName=getClassFullName(mTableName_upperCamelCase, getRuleEntity());//类全称
...
//        }
		 ...
		 CodeHelper.addCodeLine(sql,String.format("public class %s implements Serializable {", mClassSimpleName) );
		 sql.append(lf);
		 ...
		 if(attrs!=null)
		 {
			 ...
			 { 
				 ...
				 CodeHelper.addCodeLine(publicStr,String.format("public void set%s(%s %s){",codeName_upperCamelCase,CodeHelper.columnType2JavaType(attr),codeName) );
				 CodeHelper.addCodeLine(publicStr,String.format("this.%s = %s;",codeName,codeName));
				 CodeHelper.addCodeLine(publicStr, "	}");
				 
				 CodeHelper.addCodeLine(publicStr, String.format("public %s get%s(){",CodeHelper.columnType2JavaType(attr),codeName_upperCamelCase));
				 CodeHelper.addCodeLine(publicStr,  String.format("return this.%s;",codeName));
				 CodeHelper.addCodeLine(publicStr, "	}");
		 ...
		 sql.append(lf);
		 CodeHelper.addCodeLine(sql, publicStr.toString());
		 sql.append(lf);
